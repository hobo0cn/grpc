...
```
$ go get -u github.com/hobo0cn/grpc/examples/helloworld/greeter_client
$ go get -u github.com/hobo0cn/grpc/examples/helloworld/greeter_server
```
...
1. Rebuild the generated Go code
   ...
   ```
   $ go generate github.com/hobo0cn/grpc/examples/helloworld/...
   ```
